     ...
     public class Paciente_Datos
    {
        ...
        public void GuardarPaciente(Paciente p, ref int verificar)
        {
            try
            {
                ...
                object[] Parametros = { p.Nombre, p.Apellido, p.Telefono, p.NivColesterol, p.PromGrasa, p.Estatura, p.Edad, p.Talla, p.Peso, p.NivTrigliceridos, p.NivAcidoUrico, p.IDTratamiento};
        ...
        public List<Tratamiento> ObtenerTratamiento(string conexion)
        {
            try
            {
                conexion = ConfigurationManager.AppSettings.Get("strConnection");
                ...
                Tratamiento Item;
                SqlDataReader Dr = SqlHelper.ExecuteReader(conexion, CommandType.StoredProcedure, "dbo.ComboTratamiento");
                while (Dr.Read())
                {
        ...
        public void GuardarPacienteModificado(Paciente p)
        {
            try
            {
                object[] Parametros = { p.IDPaciente, p.Nombre, p.Apellido, p.Telefono, p.NivColesterol, p.PromGrasa, p.Estatura, p.Edad, p.Talla, p.Peso, p.NivTrigliceridos, p.NivAcidoUrico, p.IDTratamiento};
